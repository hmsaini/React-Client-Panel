        ...
        <div className="card-body">
            <form onSubmit={this.onSubmit}>
                <div className="form-group">
                    ...
                    // use defaultValue so that we can change input fields
                    // now client is prop, but not a state
                    // so we have to use REF and use CONSTRUCTOR
                ...
                <div className="form-group">
                    ...
                    defaultValue={client.lastName}></input>
                </div>
                ...
                <div className="form-group">
                    ...
                    required
                    ref={this.emailInput}
                    defaultValue={client.email}></input>
                </div>
                ...
                <div className="form-group">
                    ...
                    required
                    ref={this.phoneInput}
                    defaultValue={client.phone}></input>
                </div>
                ...
                <div className="form-group">
                    ...
                    disabled={disableBalanceOnEdit}></input>
                </div>
